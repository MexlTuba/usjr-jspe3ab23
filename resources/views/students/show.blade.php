...
<ul class="list-group">
    ...
    <li class="list-group-item"><strong>Program:</strong> {{ $student->program->progfullname }}</li>
    <li class="list-group-item"><strong>College:</strong> {{ $student->college->collfullname }}</li>
